...
public class Inventory extends TableImpl<InventoryRecord> {
    ...
    private static final long serialVersionUID = 2140188562;

    /**
     * The reference instance of <code>jbprojekt.inventory</code>
     */
    ...
    /**
     * The column <code>jbprojekt.inventory.id</code>.
     */
    public final TableField<InventoryRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>jbprojekt.inventory.created_time</code>.
     */
    public final TableField<InventoryRecord, Timestamp> CREATED_TIME = createField("created_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>jbprojekt.inventory.state_id</code>.
     */
    public final TableField<InventoryRecord, Integer> STATE_ID = createField("state_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * Create a <code>jbprojekt.inventory</code> table reference
     */
    public Inventory() {
    ...
    /**
     * Create an aliased <code>jbprojekt.inventory</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.INVENTORY_PRIMARY);
    }
